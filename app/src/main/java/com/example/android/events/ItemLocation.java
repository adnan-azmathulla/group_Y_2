...
public class ItemLocation extends FragmentActivity implements OnMapReadyCallback,
    ...
    int PROXIMITY_RADIUS =500 ; //distance (in meters)
        ...
        RadiusSeekBar.setOnSeekBarChangeListener(new OnSeekBarChangeListener(){
            ...
            public void onProgressChanged(SeekBar seekBar, int progressValue, boolean fromUser) {
               ...
               // PROXIMITY_RADIUS+=500; ;
                progressValue = RadiusSeekBar.getProgress();
                PROXIMITY_RADIUS=PROXIMITY_RADIUS * progressValue;
                progress=progressValue;
                progressBar.setProgress(progress);
                textView.setText(""+progress+"meters");
